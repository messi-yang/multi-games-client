...
export class WorldJourneyService {
  ...
  constructor(world: WorldModel, players: PlayerModel[], myPlayerId: string) {
    this.world = world;
    ...
    this.commandManager = CommandManager.create(world, this.playerManager, this.perspectiveManager);
  ...
  static create(world: WorldModel, players: PlayerModel[], myPlayerId: string) {
    return new WorldJourneyService(world, players, myPlayerId);
  }
